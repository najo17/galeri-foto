...
<body class="min-h-screen bg-[#F8F4EC] p-4 text-[#43334C]">
    ...
    <a href="home.php" class="inline-block mb-4 text-[#E83C91] font-semibold hover:underline"> Kembali ke Home</a>
    ...
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl p-6 border border-[#43334C]">
        ...
        ?>
            <div class="p-4 bg-[#F8F4EC] border border-[#43334C] rounded-lg shadow-sm">
                <b class="text-[#E83C91]"><?= $k['Username']; ?></b>
                <p><?= $k['IsiKomentar']; ?></p>
            </div>
        <?php } ?>
        </div>
        ...
        <form method="post" action="comment.php" class="space-y-4">
            <input type="hidden" name="fotoid" value="<?= $id; ?>">
            <textarea name="isi" placeholder="Tulis komentar..." class="w-full h-28 p-4 border border-[#43334C] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E83C91]"></textarea>

            <button class="px-6 py-3 bg-[#E83C91] text-white font-semibold rounded-xl hover:bg-[#FF8FB7] transition">Kirim Komentar</button>
        </form>
